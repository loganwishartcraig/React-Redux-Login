...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ContainersMainApp = __webpack_require__(175);

	var _ContainersMainApp2 = _interopRequireDefault(_ContainersMainApp);

	var _ReducersLoginReducers = __webpack_require__(180);

	var _ReducersLoginReducers2 = _interopRequireDefault(_ReducersLoginReducers);

	var store = (0, _redux.createStore)(_ReducersLoginReducers2['default']);
	...
	_react2['default'].render(_react2['default'].createElement(
	  ...
	  { store: store },
	  function () {
	    return _react2['default'].createElement(_ContainersMainApp2['default'], null);
	  }
	), rootElement);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoginContainer = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ActionsLoginActions = __webpack_require__(177);

	var _ComponentsUsernameField = __webpack_require__(178);

	var _ComponentsUsernameField2 = _interopRequireDefault(_ComponentsUsernameField);

	var _ComponentsPasswordField = __webpack_require__(179);

	var _ComponentsPasswordField2 = _interopRequireDefault(_ComponentsPasswordField);
	...
	var LoginContainer = (function (_Component) {
	  ...
	  function LoginContainer() {
	    ...
	    _get(Object.getPrototypeOf(LoginContainer.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  _createClass(LoginContainer, [{
	    ...
	    value: function render() {
	      ...
	      var usernameText = _props.usernameText;
	      var passwordText = _props.passwordText;
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'form',
	          { className: 'login--form', action: '/api/authenticate', method: 'POST' },
	          _react2['default'].createElement(
	            'label',
	            { className: 'login--label' },
	            'Username'
	          ),
	          _react2['default'].createElement(_ComponentsUsernameField2['default'], { handleChange: function (text) {
	              dispatch((0, _ActionsLoginActions.updateUsername)(text));
	            } }),
	          _react2['default'].createElement(
	            'label',
	            { className: 'login--label' },
	          ...
	          _react2['default'].createElement(_ComponentsPasswordField2['default'], { handleChange: function (text) {
	              dispatch((0, _ActionsLoginActions.updatePassword)(text));
	            } }),
	          _react2['default'].createElement(
	            'button',
	            { className: 'login--btn--submit', type: 'submit', onClick: function (evt) {
	                evt.preventDefault();$.ajax('/api/authenticate', {
	                  type: 'POST',
	                  contentType: 'application/json',
	                  data: JSON.stringify({
	                    username: _this.props.usernameText,
	                    password: _this.props.passwordText
	                  }),
	                  dataType: 'json'
	                }).done(function (res) {
	                  if (res.success === true) {
	          ...
	          _react2['default'].createElement(
	            'a',
	            { className: 'login--btn--signup', href: '/signup' },
	            'Sign Up'
	          )
	        ),
	        _react2['default'].createElement('span', { className: 'login--text--error', className: 'error-text', style: { color: 'red' } })
	      );
	    }
	  }]);
	...
	var LoginModule = (0, _reactRedux.connect)(select)(LoginContainer);
...
/***/ function(module, exports) {
	...
	var updateUsername = function updateUsername(text) {
	  return {
	...
	var updatePassword = function updatePassword(text) {
	  return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UsernameFeild = (function (_Component) {
	  _inherits(UsernameFeild, _Component);

	  function UsernameFeild() {
	    _classCallCheck(this, UsernameFeild);

	    _get(Object.getPrototypeOf(UsernameFeild.prototype), "constructor", this).apply(this, arguments);
	  }

	  _createClass(UsernameFeild, [{
	    key: "handleChange",
	    value: function handleChange(evt) {
	      evt.preventDefault();
	      var username = (0, _react.findDOMNode)(this.refs.username).value.trim();
	    ...
	    value: function render() {
	      ...
	      return _react2["default"].createElement("input", { className: "login--input", type: "text", ref: "username", value: this.props.username, name: "username", onChange: function (evt) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PasswordFeild = (function (_Component) {
	  _inherits(PasswordFeild, _Component);

	  function PasswordFeild() {
	    _classCallCheck(this, PasswordFeild);

	    _get(Object.getPrototypeOf(PasswordFeild.prototype), "constructor", this).apply(this, arguments);
	  }

	  _createClass(PasswordFeild, [{
	    key: "handleChange",
	    value: function handleChange(evt) {
	      evt.preventDefault();
	      var password = (0, _react.findDOMNode)(this.refs.password).value.trim();
	    ...
	    value: function render() {
	      ...
	      return _react2["default"].createElement("input", { className: "login--input--password", type: "password", ref: "password", value: this.props.password, name: "password", onChange: function (evt) {
	          _this.handleChange(evt);
	        } });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function usernameField(state, action) {
	  ...
	  switch (action.type) {
	    case _ActionsLoginActions.UPDATE_USERNAME:
	      return action.text;
	    default:
	      return state;
	  }
	...
	function passwordField(state, action) {
	  ...
	  switch (action.type) {
	    case _ActionsLoginActions.UPDATE_PASSWORD:
	      return action.text;
	    default:
	      return state;
	  }
	...
	var loginModule = (0, _redux.combineReducers)({
